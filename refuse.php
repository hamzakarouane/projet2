    ...
    <table id="example" class="table table-striped" style="width: 100%;">
        ...
        <tbody>
           <?php
              ...
              $sql = "select * from users where id!=1 and etatacademique='refuse'";
    ...
    <table id="example" class="table table-striped" style="width: 100%;">
        ...
        <tbody>
           <?php
              ...
              $sql = "select * from users where id!=1 and etatscientifique='refuse'";
              $result = mysqli_query($conn,$sql);
    ...
    <table id="example" class="table table-striped" style="width: 100%;">
        ...
        <tbody>
           <?php
              ...
              $sql = "select * from users where id!=1 and etatpedagogique='refuse'";
              $result = mysqli_query($conn,$sql);
