    ...
    <table id="example" class="table table-striped" style="width: 100%;">
        ...
        <tbody>
           <?php
              ...
              $sql = "select * from users where id!=1 and etatacademique='en attente'";
    ...
    <table id="example" class="table table-striped" style="width: 100%;">
        ...
        <tbody>
           <?php
              ...
              $sql = "select * from users where id!=1 and etatscientifique='en attente'";
              $result = mysqli_query($conn,$sql);
    ...
    <table id="example" class="table table-striped" style="width: 100%;">
        ...
        <tbody>
           <?php
              ...
              $sql = "select * from users where id!=1 and etatpedagogique='en attente'";
              $result = mysqli_query($conn,$sql);
